...
// Define fonts
#set text(font: "Fira Sans", weight: "regular", size: 10pt)
#show raw: set text(font: "Fira Code", size: 10pt, stylistic-set: 1) // Enable ligatures for code
#show math.equation: set text(font: "Fira Math", size: 10pt)

#let some-color = rgb("#ef4444")

#showybox(
  frame: (
    border-color: some-color.darken(50%),
    title-color: some-color.lighten(60%),
    body-color: some-color.lighten(80%),
  ),
  title-style: (
    color: black,
    weight: "bold",
